...
public class UFOSpawner : IGameUpdatable, IServisable
{
    ...
    private readonly TargetFollowerObjectPoolCreator _objectPoolCreator;
    ...
    public UFOSpawner(ServiceLocator serviceLocator, TargetFollowerObjectPoolCreator objectPoolCreator, Bounds bounds)
    {
